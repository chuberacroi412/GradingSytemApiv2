    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleModuleMaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleModuleMaps_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleModuleMaps_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleModuleMaps_ModuleId",
                table: "RoleModuleMaps",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleModuleMaps_RoleId",
                table: "RoleModuleMaps",
                column: "RoleId");
        }
